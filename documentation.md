...
1. В корне проекта создайте файлы `.env.local` и `.env.test.local` и укажите в нём ваши ключи доступа в соответствии с шаблоном, расположенным в файле `.env.template` .
